                     ...
                     ?>
                             ...
                             ?>
                                ...
                                <?php if($n_rows>1) { ?> <button class="btn " data-toggle="collapse"
                                    data-target="#demo<?php echo $q_id ?>">See More <i
                    ...
                    if($_SESSION['user']==$author_name){
                        ?>
                          ...
                          ?>
                                ...
                                { ?>
                                            <div class="media-body">
                                                <video controls width="350px" style="padding: 0px 15px; ">
                                                    <source src="<?php echo 'upload/' . $video; ?>"
                                        ...
                                        ?>
                                                ...
                                                <div class="modal" id="popupModal<?php echo $ans_id; ?>">
                                                    <div class="modal-content">
                                                        ...
                                                        <h2>Your Answer</h2>
                                                        <form method="POST"
                                                            action="edit.php?d_ID=<?php echo  $ans_id ?>">
                                                ...
                                                <a href='delete.php?ans_id= <?php echo $ans_id;  ?>  '> <i
                                ...
                                <div class="comment mt-3">
                                    ...
                                    <form action="combined_form_handler.php?d_id=<?php echo $q_id ?>" method="POST"
                                        ...
                                        <div class="form-group">
                                            <input type="file" class="form-control-file" name="file" accept="video/*">
                                        </div>
