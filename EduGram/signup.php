    ...
    <body id="_6">
        ...
        <?php
            ...
            if( isset( $_POST["submit"] ) )
            {
                ...
                $query = "INSERT INTO users(id,username,password,name,email,join_date) values( NULL, '$username', '$password', '$name', '$email', CURRENT_TIMESTAMP )";
